...
declare -a DESCRIPTIONS=(
    ...
    # "Post-Editing Comet Score"
    # "Post-Editing (Without Quality Score) Comet Score"
    # "Post-Editing Gemini GRB&GRF Score"
    # "Post-Editing (Without Quality Score) Gemini GRB&GRF Score"
    # "Post-Editing Gemini GEA Score"
    # "Post-Editing (Without Quality Score) Gemini GEA Score"
)
...
declare -a ROOT_DIRECTORIES=(
    ...
    # "/scratch/project_462000941/members/zihao/rm4mt/post_edited_with_comet"
    # "/scratch/project_462000941/members/zihao/rm4mt/post_edited_without_quality_score_with_comet"
    # "/scratch/project_462000941/members/zihao/rm4mt/post_edited_with_grb_grf"
    # "/scratch/project_462000941/members/zihao/rm4mt/post_edited_without_quality_score_with_grb_grf"
    # "/scratch/project_462000941/members/zihao/rm4mt/post_edited_with_gea"
    # "/scratch/project_462000941/members/zihao/rm4mt/post_edited_without_quality_score_with_gea"
)
